...
summary(model_q_score)
# only grade is a significant predictor, not their chosen difficulty level

model_login <- lm(login_count ~ difficulty_summarized * grade, data = data_model)
summary(model_login)
# same

model_nina <- lm(difficulty_summarized ~ login_count * grade, data = data_model)
summary(model_login)
```
