...
plot1 <- data_plot1 %>%
  ggplot(aes(x = factor(grade, levels = c("2", "3", "4"), labels = c("Grade 2", "Grade 3", "Grade 4")),
             y = proportion,
...
plot2 <- data_plot2 %>%
  ...
  labs(x = "", # hide the x axis label because it is visible in the third plot
       y = "Q-score",
       fill = "Difficulty",
       subtitle = "Note that the y axes are free here") +
  theme_here +
  scale_fill_manual(values = colors_here) +
  scale_y_continuous(breaks = plot2_breaks)
```
...
legend <- get_legend(plot1 +
                       ...
                       theme(legend.position = "bottom",
                             ...
                             legend.spacing.x = unit(0.7, "cm"))) # to make the legend nicer
